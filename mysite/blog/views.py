...
def product_detail(request):
    sqliteConnection = sqlite3.connect('/Users/ramjashan/CSIII/Student Repository/Student/mysite/mysite/database.db')
    try:
        output = []
        ...
        if sqliteConnection:
            ...
            return render(request, 'adminfile/test.html', {'product': output})
